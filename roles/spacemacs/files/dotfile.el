...
before packages are loaded."
  ...
  (setq bibtex-completion-bibliography '("~/src/bibs/Projetos Ativos 2019.bib"))
  ...
  (global-set-key (kbd "C-]") 'spacemacs/alternate-buffer)

  ;; pollux rpi specials
  (toggle-truncate-lines -1)
  (load "~/.emacs.d/private/new-emacs-config.el") ;; => desabilitado em 2020-06-03 para teste
  )
...
This function is called at the very end of Spacemacs initialization."
  (custom-set-variables
   ...
   '(diogenes-cli-cmd "/Applications/Diogenes.app/Contents/server/diogenes-cli.pl")
   '(fill-column 68)
   ...
   '(phi-repository-alist
     '(("phi" "/Users/brunoc/Seafile/Notas/phi/" "2508")
       ("alpha" "/Users/brunoc/Seafile/Notas/alpha/" "7000")
       ("diário" "/Users/brunoc/Seafile/Notas/Diário/" nil)))
